...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Aravinth",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Aravinth*!"""})
...
# TABLE CREATION
mycursor.execute('''CREATE TABLE IF NOT EXISTS card_data1
